...
import FilterListIcon from "@mui/icons-material/FilterList"; // Correct for MUI v5
import ArrowUpwardIcon from "@mui/icons-material/ArrowUpward"; // Correct for MUI v5
import ArrowDownwardIcon from "@mui/icons-material/ArrowDownward"; // Correct for MUI v5
...
const useStyles = makeStyles((theme) => ({
  ...
  statusBlock: {width: "100%",height: "100%",display: "flex",alignItems: "center",justifyContent: "center",textTransform: "uppercase",
  },
  jobTileOuter: {padding: "30px",margin: "20px 0",boxSizing: "border-box",width: "100%",
  },
        ...
        <Grid container direction="column" alignItems="center" spacing={3}>
          ...
          <Grid container item alignItems="center">
            ...
            <Grid item container direction="row" xs={9}>
              ...
              <Grid item container xs={4} justify="space-around"alignItems="center"style={{ border: "1px solid #D1D1D1", borderRadius: "5px" }}
              >
                <Grid item>
                  <Checkbox name="dateOfApplication" checked={searchOptions.sort.dateOfApplication.status} onChange={(event) =>
                      setSearchOptions({
                        ...searchOptions,
                        sort: {
                          ...searchOptions.sort,
              ...
              >
                <Grid item>
                  <Checkbox name="rating"  checked={searchOptions.sort["jobApplicant.rating"].status}
                    onChange={(event) =>
                      setSearchOptions({
                        ...searchOptions,
                        sort: {
          ...
          <Grid item>
            <Button variant="contained" color="primary"style={{ padding: "10px 50px" }} onClick={() => getData()}
            >
              Apply
            </Button>
          </Grid>
